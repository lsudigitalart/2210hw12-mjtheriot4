...
listen(9999, "localhost", function(conn) {
...
// Much of the below code is from the amazing Definitive Guide to HTML5 WebSocket Example WebSocket server
...
// function websocket() {
  listen = function(port, host, connectionHandler) {
